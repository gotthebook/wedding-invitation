/**
 * Google Maps Module
 * Embeds an interactive Google Map and handles directions link
 */
...
export function initMap() {
  // Create an embedded Google Map iframe
  const mapContainer = document.getElementById('map-container');
  
  // Construct the embed URL with the venue coordinates and place ID
